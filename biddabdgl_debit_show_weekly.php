...
<body style="overflow-y:auto;">
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <div class="col-12 text-center text-sm-start">
                                <center><h2>BIDDABD GOBAL WEEKLY TRANSACTION</h2> 
            ...
            </div> <br> <!-- -------------------------------Delete Function Starts here------------------------------- -->
                                ...
                                <?php while ($element = mysqli_fetch_assoc($item)) { ?>
                                     <tr style="color: white;">
                                        ...
                                        <td><?php echo $element['date']; ?></td>
                                         <td><center><a class="btn btn-danger" href="biddabdgl_debit_show_weekly.php?data=delete&&biddabdgl_debit_show_weekly_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i> </a> 
